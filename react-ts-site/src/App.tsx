  ...
  },
  {
    ...
    leetcodeStats: {
      ...
      solved: [
        ...
        { label: "Medium", shortLabel: "Med.", count: 36, total: 2027, colorClassName: "leetcode-medium" },
  ...
  },
  {
    ...
    leetcodeStats: {
      ...
      solved: [
        ...
        { label: "Medium", shortLabel: "Med.", count: 21, total: 49, colorClassName: "leetcode-medium" },
  ...
  },
  {
    ...
    leetcodeStats: {
      ...
      solved: [
        ...
        { label: "Medium", shortLabel: "Med.", count: 32, total: 101, colorClassName: "leetcode-medium" },
